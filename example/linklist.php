...
if (!isset($TEMPLATE)) {
	$TITLE = 'Link List';
	$NAVIGATION = true;
	$HEAD = '<link rel="stylesheet" href="/theme/css/linklist.css"/>';
  ...
  <li>
    <a href="#3">
      ...
      <p>A team of scientists have been gathering data from new paleoseismic
        ...
        spanned fault segment boundaries. They are also analyzing new
        high-resolution airborne LiDAR topographic data to characterize
        previously unmapped fault traces and to measure how vertical
        displacements (vertical offset of the ground surface from faulting)
        vary, both in space (from north to south) and time (the last 20,000
        years).
      </p>
    </a>
  </li>
