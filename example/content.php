...
<ul>
  ...
  <li>
    ...
    <code>target=&ldquo;_blank&rdquo;</code>.
  </li>
</ul>
...
<ul>
  <li>
    Site navigation will always appear off-canvas on small-format and at the
    bottom-left on large-format.
  </li>
  <li>
    If local navigation is needed, it will appear above the site navigation.
  </li>
  <li>
    If the webpage is more than one level below the site section, a navigation
  ...
  <li>
    Navigation text should match the title of the webpage you&rsquo;re linking
    to. If it is too long, you can shorten it but don't change any of the words.
  </li>
</ul>
...
<ul>
  ...
  <li>
    &ldquo;and&rdquo; versus &ldquo;&amp;&rdquo; - always use &ldquo;and&rdquo;
      in copy, and in headers and navigation links as much as possible, instead
      of &ldquo;&amp;&rdquo;.
  </li>
  <li>U.S. not US.</li>
  <li>
    USGS not U.S.G.S., &ldquo;U.S. Geological Survey&rdquo;, &ldquo;US
    Geological Survey&rdquo;.
  </li>
  <li>
  ...
  <li>
    ...
    <ul>
      <li>
        make science about people too, not just data and research, include
        photos of people.
      </li>
...
<ul>
  <li>
    <a href="https://github.com/usgs/hazdev-template/">Website Overview,
