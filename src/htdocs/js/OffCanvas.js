...
/**
 * OffCanvas manages classes and elements for moving content "off canvas" on
 * smaller screens.
 *
 * OffCanvas uses the singleton design pattern and exposes the method
 * OffCanvas.getOffCanvas(options) to construct or access this object.
 */
